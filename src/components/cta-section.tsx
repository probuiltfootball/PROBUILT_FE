...
export default function CtaSection() {
  ...
  return (
    <section className="pb-20 px-6">
      <motion.div
        className="max-w-7xl bg-[#00000080] rounded-3xl py-12 mx-auto border border-[#00FFC220]"
        initial={{ y: 0 }}
        animate={{
      ...
      >
        ...
        >
          ...
          >
            Stay Ahead of the Competition Train with UEFA-licensed coaches and start
